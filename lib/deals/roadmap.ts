...
export const DEFAULT_ROADMAP: RoadmapSeed[] = [
  ...
  { phase: "P0", order: 3, title: "Write the one-page offer",
    detail: "Services rev-share on incremental net + per-channel launch fee + excess-inventory consignment (we list, brand ships, we take a cut). Rate set per deal, not published. This is your pitch attachment." },
  ...
  { phase: "P1", order: 1, title: "Sell the low-commitment version first",
    detail: "An excess-inventory consignment run, or a single-channel pilot (just Walmart). Easy yes; opens the door to full management." },
